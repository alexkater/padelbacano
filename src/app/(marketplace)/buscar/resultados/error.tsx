    ...
    <main className="flex min-h-[100dvh] items-center justify-center bg-[var(--pb-surface-canvas)] px-[var(--pb-space-4)]">
      <section className="w-full max-w-md rounded-[var(--pb-radius-xl)] border border-[var(--pb-status-error)]/20 bg-[var(--pb-surface-primary)] p-[var(--pb-space-8)] text-center shadow-[var(--pb-shadow-card)]">
        ...
        <p className="mt-[var(--pb-space-3)] text-[length:var(--pb-text-body)] text-[var(--pb-text-secondary)]">
          No pudimos cargar los resultados. Revisa tu conexión o intenta con una búsqueda diferente.
        </p>
        ...
        <p className="mt-[var(--pb-space-5)] text-[length:var(--pb-text-body-sm)] text-[var(--pb-text-secondary)]">
          ¿Problemas persistentes?{" "}
          <Link
            className="font-semibold text-[var(--pb-brand-primary)] underline-offset-4 hover:underline focus-visible:outline-none focus-visible:shadow-[var(--pb-ring-focus)]"
            href="/contacto"
          >
            Reportar problema
          </Link>
